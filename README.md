# Hello-world
Eggplant - 龍谷大学ハッカソンプロジェクト
概要
Eggplantは、AzureとLINE APIを活用して、龍谷大学のウェブサイトから取得した混雑状況とカフェテリアメニュー情報をユーザーに提供するシステムです。本システムは、ユーザーがLINEを通じて簡単に混雑状況を確認し、推奨メニューを受け取ることができるように設計されています。
